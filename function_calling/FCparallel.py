...
def main():
    ...
    for i, item in enumerate(data):
        try:
            ...
            # Use custom system message for parallel function calls
            system_message = "you are a helpful assistant that can answer questions by calling on given functions. You can call the same function multiple times if needed."
